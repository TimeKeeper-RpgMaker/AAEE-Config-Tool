...
{
    /// <summary>This class serves as datapack for state configuration.</summary>
    [XmlType("DataPackState")]
    public class DataPackState : IResetable
    {
        #region Defaults
        ...
        private decimal defaultDefCritRateMul = 0;
        ...
        private decimal defaultDefCritDamageMul = 0;
        ...
        private decimal defaultDefSpCritRateMul = 0;
        ...
        private decimal defaultDefSpCritDamageMul = 0;
        ...
        private decimal defaultDefSkillCritRateMul = 0;
        ...
        private decimal defaultDefSkillCritDamageMul = 0;
        ...
        private decimal defaultDefSkillSpCritRateMul = 0;
        ...
        private decimal defaultDefSkillSpCritDamageMul = 0;
        ...
        private decimal defaultAtkMul = 0;
        private int defaultAtkAdd = 0;

        // Default hit rate
        private bool defaultCustomHit = false;
        private decimal defaultHitMul = 0;
        ...
        private decimal defaultSpCritDefGuardMul = 0;
        ...
        private decimal defaultSpCritDefEvaMul = 0;
        ...
        private List<State> stateFamily = new List<State>();
        ...
        /// <summary>Gets or sets the list of state in the family.</summary>
        public List<State> StateFamily
        {
            get { return stateFamily; }
            set { stateFamily = new List<State>(value); }
        }
        ...
        public DataPackState(int inpuntID)
        {
            this.id = inpuntID;
        ...
        public DataPackState(int inpuntID, string inputName)
        {
            this.id = inpuntID;
            this.name = inputName;
            this.Reset();
        ...
        public bool Equals(DataPackState other)
        {
        ...
        public virtual void CloneFrom(DataPackState other)
        {
            // ID and Name
            this.ID = other.ID;
            ...
            this.StateFamily.Clear();
            if (other.StateFamily.Count > 0)
            {
                foreach (State state in other.StateFamily)
                {
                    this.StateFamily.Add(new State(state.ID, state.Name));
                }
            }
        ...
        /// <param name="other">Other configuration to copy</param>
        public virtual void PasteFrom(DataPackState other)
        {
            #region Parameter
